...
- (IBAction)seApretoBotonIzquierdo:(UIBarButtonItem *)sender {
    
    [self.miDelegado PrincipalApretoBotonIzquierdo];
}

- (IBAction)seApretoBotonDerecho:(UIBarButtonItem *)sender {
